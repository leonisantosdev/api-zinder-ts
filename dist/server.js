...
const options = {
    swaggerDefinition,
    // Aqui você aponta para os arquivos que contem as anotações para gerar docs (ex: rotas)
    apis: ['./src/routes/*.js', './src/models/*.js'], // ajuste o caminho conforme seu projeto
};
